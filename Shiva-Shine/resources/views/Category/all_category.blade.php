        ...
        <div class="grid gap-6 grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4" id="productGrid">
            ...
            @foreach ($products as $product)
                <div data-category="{{ $product['category'] }}"
                    class="bg-white rounded-xl overflow-hidden shadow hover:shadow-md transition relative group">
                    ...
                    <div class="p-4 text-center">
                        ...
                        <!-- Add to Cart -->
                        <button
                            class="mt-4 w-full bg-[#ffd9df] hover:bg-[#fcb8c5] text-[#633d2e] font-semibold py-2 rounded-lg transition duration-200">
                            Add to Cart
                        </button>
                    </div>
                </div>
