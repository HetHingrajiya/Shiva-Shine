...
@section('content')
    ...
    <section class="w-full bg-[#fffaf7]">
        ...
        <div class="hidden md:block mt-14">
            <img src="{{ asset('images/files/106_rakhi_gold_jewellery__offer_hero_web-minda97.jpg') }}"
                alt="Desktop Banner" class="w-full h-auto object-cover" />
        </div>

        <!-- Mobile Banner -->
        <div class="md:hidden mt-20">
            <img src="{{ asset('images/files/106_rakhi_gold_jewellery__offer_hero_phone_-min5d78.jpg') }}"
                alt="Mobile Banner" class="w-full h-auto object-cover" />
        </div>
    </section>
    ...
    <section class="py-10 bg-[#fffaf7]">
        <div class="max-w-6xl mx-auto px-4">
            ...
            <!-- Section Title -->
            <h2 class="text-3xl font-semibold text-center text-[#633d2e] mb-6">
                Latest Collections by Category
            </h2>
