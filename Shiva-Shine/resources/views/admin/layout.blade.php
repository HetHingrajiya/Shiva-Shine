...
<div class="flex h-screen">
  ...
  <!-- Sidebar -->
  <aside id="sidebar" class="w-64 bg-gradient-to-b from-pink-100 to-pink-200 shadow-lg flex flex-col fixed h-full transition-transform duration-300 z-20">
 <div class="p-3 border-b border-pink-200 flex items-center justify-between bg-white shadow-sm">
    <div class="flex items-center gap-1">
        <span class="text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-rose-400 to-pink-600
    ...
    <nav class="flex-1 p-4 space-y-1">
      <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-3 px-3 py-2 rounded-md hover:bg-pink-50 text-pink-800 hover:text-pink-600 transition active:bg-pink-200">
        <i data-feather="home"></i><span>Dashboard</span>
      </a>
      <a href="#" class="flex items-center gap-3 px-3 py-2 rounded-md hover:bg-pink-50 text-pink-800 hover:text-pink-600 transition">
        <i data-feather="users"></i><span>Users</span><span class="ml-auto bg-pink-500 text-white text-xs rounded-full px-2 py-0.5">12</span>
      </a>
      <a href="#" class="flex items-center gap-3 px-3 py-2 rounded-md hover:bg-pink-50 text-pink-800 hover:text-pink-600 transition">
    ...
    <div class="p-4 border-t border-pink-300">
      <a href="{{ route('admin.logout') }}" class="flex items-center gap-3 px-3 py-2 rounded-md hover:bg-red-50 text-red-700 transition">
  ...
  <div class="flex-1 flex flex-col md:ml-64 transition-all">
    ...
    <!-- Topbar -->
    <header class="bg-white shadow-md flex justify-between items-center px-6 py-3 sticky top-0 z-10 border-b border-gray-200">
      ...
      <div class="flex items-center gap-4">
        ...
        <div class="relative hidden sm:block">
          <input type="text" placeholder="Search..." class="pl-10 pr-4 py-2 rounded-full border border-gray-300 focus:outline-none focus:ring-2 focus:ring-pink-300 w-64">
        ...
        <div class="relative">
          ...
          <div id="notifMenu" class="hidden absolute right-0 mt-2 w-60 bg-white rounded-lg shadow-lg border border-gray-100 z-50">
        ...
        <!-- User Menu -->
        <div class="relative">
          <button id="userBtn" class="flex items-center gap-2 cursor-pointer hover:bg-pink-50 px-3 py-1 rounded-full">
          ...
          <div id="userMenu" class="hidden absolute right-0 mt-2 w-40 bg-white rounded-lg shadow-lg border border-gray-100 z-50">
            ...
            <a href="{{ route('admin.logout') }}" class="block px-4 py-2 hover:bg-red-50 text-red-600 font-medium">Logout</a>
          </div>
        </div>
      </div>
    </header>
...
<script>
  ...
  document.getElementById('toggleSidebar').addEventListener('click', () => sidebar.classList.add('-translate-x-full'));
