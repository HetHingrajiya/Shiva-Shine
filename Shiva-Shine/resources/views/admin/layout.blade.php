...
<body class="bg-gray-50 antialiased text-sm">
  <div class="flex h-screen">
    ...
    <!-- Sidebar -->
    <aside id="sidebar" class="w-72 glass border-r border-gray-200 fixed h-full flex flex-col transition-transform duration-300 z-30 -translate-x-full md:translate-x-0 shadow-lg">
        ...
        @foreach($links as $link)
          ...
          @else
            <a href="{{ $link['route'] }}"
              ...
              {{ $link['label'] }}
              @if(!empty($link['badge']))
                <span class="ml-auto bg-gray-900 text-white text-xs rounded-full px-2 py-0.5">{{ $link['badge'] }}</span>
              @endif
            </a>
          @endif
        @endforeach
    ...
    <div class="flex-1 flex flex-col md:ml-72 transition-all">
      ...
      <!-- Topbar -->
      <header class="h-16 glass border-b border-gray-200 flex justify-between items-center px-6 sticky top-0 z-20 shadow-sm">
        ...
        <div class="flex items-center gap-4">
          ...
          <div class="relative">
            ...
            <div id="notifMenu" class="hidden absolute right-0 mt-2 w-72 bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
              <div class="p-3 text-sm font-semibold text-gray-700 border-b">Notifications</div>
              <div class="divide-y divide-gray-100">
                <div class="p-3 text-sm hover:bg-gray-50 cursor-pointer">💎 New order for Diamond Necklace</div>
                <div class="p-3 text-sm hover:bg-gray-50 cursor-pointer">👤 New customer registered</div>
          ...
          <div class="relative">
            ...
            <div id="userMenu" class="hidden absolute right-0 mt-2 w-40 bg-white rounded-lg shadow-lg border border-gray-100">
