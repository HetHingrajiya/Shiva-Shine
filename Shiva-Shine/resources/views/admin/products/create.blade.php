            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="short_description" placeholder="Minimalist silver ring for daily wear"
                            required
                            class="w-full border border-gray-300 rounded-xl px-4 py-2 focus:ring-2 focus:ring-indigo-400 focus:outline-none shadow-sm">
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="4" placeholder="Write a detailed description of the product..." required
                            class="w-full border border-gray-300 rounded-xl px-4 py-2 focus:ring-2 focus:ring-purple-400 focus:outline-none shadow-sm"></textarea>
                    </div>
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-3">Upload up to 5 images (JPG, PNG, max 2MB each). First image is
                        required.</p>
                </div>
