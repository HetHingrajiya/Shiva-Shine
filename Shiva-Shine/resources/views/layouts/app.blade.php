...
<body class="bg-[#fffaf7] text-[#633d2e]">
    ...
    <nav class="fixed top-0 left-0 w-full z-50 bg-[#fffaf7] shadow-sm border-b border-gray-200" x-data="{ open: false }">
        ...
        <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <!-- Desktop View -->
            <div class="hidden sm:flex justify-between items-center h-18">
                <!-- Left: Logo & Location -->
                <div class="flex items-center gap-3">
                    <a href="{{ url('/') }}" class="block">
                        <img src="{{ asset('images/files/logo.png') }}" alt="Shiva Shine Logo" class="h-20 w-160">
                    </a>
            ...
            <div x-show="open" x-transition
                ...
                <a href="{{ route('category.Womens.womens_jewellery') }}" class="block hover:text-pink-500">Women's
                    Jewellery</a>
